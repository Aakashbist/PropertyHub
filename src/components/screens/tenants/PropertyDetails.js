      ...
      <View style={{ marginHorizontal: 24, alignSelf: "stretch" }}>
        ...
        >
          <Icon
            ...
            iconStyle={{ marginEnd: 16, width: 40 }}
          />
          <Text style={[styles.textSubHeading, { flexShrink: 1 }]}>
            {property.address}
          </Text>
        </View>
        ...
        <Text
          style={[styles.textSubHeading, { fontWeight: "bold", fontSize: 32 }]}
        >
          ${property.bond}
        </Text>
        ...
        <Text
          style={[
            ...
            { fontWeight: "bold", fontSize: 18, flexShrink: 1, marginTop: 8 }
          ]}
        >
          ...
          <View>
            ...
            <View style={{ flex: 1, flexDirection: "row", marginTop: 8 }}>
              <Avatar
                rounded
                size="medium"
                title={getNameInitials(owner.name)}
