...
import { getCurrentUser, getServerTimestamp, getCurrentUserClaims } from '../../config/Firebase';
import colors from '../../resources/colors';
import styles from '../../resources/styles';
import { getPropertyById, getLeasedPropertiesByTenantId, propertyReference } from '../services/PropertyService';
...
const Dashboard = (props) => {
  ...
  //   console.log(JSON.stringify(property), "picker")
  ...
  //             <Text style={[styles.textSubHeading, { flex: 1, fontSize: 21, color: colors.green }]}>Upcoming Rent {property.address}</Text>
  //             <Icon
  //               name="update"
  //               type="material"
  //               size={34}
